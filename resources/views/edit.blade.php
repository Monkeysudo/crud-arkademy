...
<body>
    ...
    <div class="container">
        <form method="POST" action="{{ route('update', $item->id) }}">
            ...
            <div class="row my-3">
              <div class="col">
                <input type="text" class="form-control" placeholder="Nama Produk" name="nama_produk" value="{{ $item->nama_produk }}">
              </div>
              <div class="col">
            ...
            <div class="row">
                <div class="col">
                  <input type="number" class="form-control" placeholder="Harga" name="harga" value="{{ $item->harga }}">
                </div>
                <div class="col">
              ...
              <div class="text-right my-2">
                <button class="col-sm-2 btn btn-primary" type="submit">update</button>
              </div>
          </form>
    </div>
</body>
